...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <link type="text/css" rel="stylesheet" href="css/keyboardbig.css?<?php echo date('l jS \of F Y h:i:s A'); ?>">
  <link type="text/css" rel="stylesheet" href="css/rasytibig.css?<?php echo date('l jS \of F Y h:i:s A'); ?>">
...
<p><button title="smaller"><a href="index.php" style="text-decoration: none; color: inherit;"><span style="font-size: 22px">A</span>&rarr;<span style="font-size: 12px">A</span></a></button>
